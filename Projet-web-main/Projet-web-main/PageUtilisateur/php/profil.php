...
<body>
    <nav>
        <header>
                <a href="indexUti.php"><div class="logo">CourseMoi</div></a>
                <div class="btn-ctn">
    ...
    <main>
        ...
        <!--<div class="security-ctn">
            ...
            <div class="info-ctn">
                <div class="bloc">
                    <div class="form__group field">
                        <input type="password" class="form__field border-width" placeholder="Mot de passe" required="">
                        <label for="mot_de_passe" class="form__label">Mot de passe</label>
                    </div>
                </div>
            </div>
        </div>-->
