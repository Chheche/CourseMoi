...
if (isset($_POST['id'])) {
    ...
    header('Location: annonceUti.php');
    exit();
}
...
<body>
            ...
            <div class="modal-content2">
                ...
                <div class="modal-main">
                    <div class="box-ligne2">
                        ...
                        <br>
                        <input type="text" class="form-input taille2" name="description" required>
                    </div>
                    ...
                    <div class="add-main">
                        ...
                        <form class="form-container" method="post">
                            ...
                            <label class="check-container check-top">
                                ...
                                <div class="checkmark"></div>
                                <p>Transport de personnes</p>
                            </label>
                            <div class="contact-ligne1" id="contact-ligne1">
                                <div class="box-ligne">
                                    <label class="input-color">Nombre de places</label>
                                    <br>
    ...
    <script src="../js/indexUti.js"></script>
</body>
</html>